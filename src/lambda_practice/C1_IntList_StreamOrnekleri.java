...
public class C1_IntList_StreamOrnekleri {
    public static void main(String[] args) {
        ...
        System.out.println("yuzeEsitYokmu(list) = " + yuzeEsitYokmu(list));
    ...
    public static boolean yuzeEsitYokmu(List<Integer> l) {
        return l.stream().allMatch(t-> t!=100); //true
    }
    // S15: listenin sifira esit elemani yok mu?
    public static boolean sifiraEsitYokmu(List<Integer> l) {
        return l.stream().allMatch(t-> t!=0); //true
    }
    ...
    public static void sonBesListele(List<Integer> l){
        System.out.println(l.stream().skip(l.size() - 5).collect(Collectors.toList()));
    }
}