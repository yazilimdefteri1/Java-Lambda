...
public class C2_StringList_StreamOrnekleri {
    public static void main(String[] args) {
        ...
        System.out.println("dcIleBasYaz = " + dcIleBasYaz(list));
        yildizliYaz(list);
        System.out.println();
        System.out.println("alfabetikSira = " +alfabetikSira(list));
        lLeriSil(list);
        System.out.println("eOlanlarinlistesi(list) = " + eOlanlarinlistesi(list));
        ilkHarfi3KereYaz(list);
        ilkHarfiBuyukYaz(list);
        System.out.println("uzunluk4ve6Haric() = " + uzunluk4ve6Haric(list));
    ...
    public static void ilkHarfi3KereYaz (List<String> l){
        ...
        public static void ilkHarfiBuyukYaz (List<String> l) {
            System.out.println();
            l.stream().
